...
class Auth with ChangeNotifier {
  ...
  Future<void> _authenticate(String email, String password, String urlSegment) async {
    try{
      final url = "https://identitytoolkit.googleapis.com/v1/accounts:$urlSegment?key=AIzaSyAmEygFRU8vYVeZSvakvlZ8wWA8o8taL1s";
  ...
  Future<bool> tryAutoLogin() async {
    ...
    //Checks if expiry is over or not
  ...
  //  prefs.remove('userData');
    prefs.clear(); //This removes all the data
    notifyListeners();
  }
