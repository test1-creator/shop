...
class Products with ChangeNotifier {
  ...
  Future<void> fetchAndSetProducts() async {
    const url =
        'https://shop-8ec6f-default-rtdb.asia-southeast1.firebasedatabase.app/products.json';
    try {
  ...
  Future<void> addProduct(Product product) async {
    const url = 'https://shop-8ec6f-default-rtdb.asia-southeast1.firebasedatabase.app/products.json';
    try {
